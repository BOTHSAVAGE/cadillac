 ...
 */
@Slf4j
public class CadillacSentinelInvocationHandler implements InvocationHandler {
	...
	CadillacSentinelInvocationHandler(Target<?> target, Map<Method, InvocationHandlerFactory.MethodHandler> dispatch,
	...
	public boolean equals(Object obj) {
		if (obj instanceof SentinelInvocationHandler) {
			CadillacSentinelInvocationHandler other = (CadillacSentinelInvocationHandler) obj;
