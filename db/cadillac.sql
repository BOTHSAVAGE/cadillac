DROP DATABASE IF EXISTS `cadillac`;

CREATE DATABASE  `cadillac` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
...
INSERT INTO `sys_menu` VALUES (9999, '系统官网', NULL, 'https://cadillac4cloud.com/#/', -1, 'icon-guanwangfangwen', 999, '0', '0', '0', ' ', '2019-01-17 17:05:19', 'admin', '2020-03-11 23:52:57');
COMMIT;
